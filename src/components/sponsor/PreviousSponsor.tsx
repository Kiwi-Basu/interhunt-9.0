  ...
  return (
    <>
      <section id="Previous-Sponsor">
        <div className="min-h-screen p-20 flex flex-col items-center bg-[#F8FAFC] relative overflow-hidden">
          ...
          <div className="flex w-6xl flex-wrap gap-5 justify-center relative z-10">
            {sponsors.map((sponsor, idx) => (
              <div
                key={idx}
                className="h-52 w-44 border border-gray-100 bg-white flex flex-col gap-3 p-4 rounded-3xl shadow-sm hover:-translate-y-2 hover:border-[#CEAC81]/30 hover:shadow-md duration-300 transition-all group cursor-pointer opacity-60 hover:opacity-100"
              >
