    ...
    <>
      <section id="upload-resume">
        <div className="min-h-screen flex flex-col items-center justify-center px-4 md:px-20 py-10 md:py-20 gap-8 md:gap-14 bg-linear-to-br from-[#a9a7a7] via-[#F8FAFC] to-[#EEF2F7]">
          ...
          <div className="w-full max-w-2xl p-6 md:p-8 flex flex-col gap-5 md:gap-6 border border-[#CEAC81]/20 rounded-3xl bg-white shadow-xl mx-4 md:mx-0">

            {/* TITLE */}
            <h1 className="text-2xl md:text-3xl font-bold text-center text-[#1F3A5F]">
              Upload Your Resume
            </h1>
          ...
          {/* APPLY BUTTON */}
          <div className="px-6 py-3 md:py-2 rounded-full font-medium text-[#1F3A5F] text-lg md:text-2xl
            bg-linear-to-r from-[#D8B893] via-[#CEAC81] to-[#BFA06F]
            shadow-md hover:shadow-lg hover:scale-105
            transition-all duration-300 cursor-pointer text-center w-[90%] sm:w-auto">
            Apply for Companies
          </div>
