      ...
      <section id="hero">
        <div className="min-h-screen relative flex items-center justify-center flex-col px-4 md:px-0 overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-6 md:mb-10 text-center z-10">
            <div className="text-6xl md:text-8xl font-extrabold "><span className="font-rayakan tracking-wider">InternHunt</span> <span className="text-[#1E3B56] font-rayakan tracking-wider">9.0</span>
            </div>
            <p className="text-lg md:text-xl mt-2 font-medium">Where the hunt ends and the career begins</p>
          </div>

          <div className="text-6xl md:text-9xl font-bold border mb-8 md:mb-10 px-6 md:px-10 py-4 md:py-5 rounded-2xl shadow-lg border-white/20 bg-[#f6f2f2] z-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-5 z-10 w-full sm:w-auto px-4 sm:px-0">
            {user ? (
              ...
              <>
                ...
                <Link to="/auth" className="w-full sm:w-auto"><button className="w-full px-8 md:px-10 md:w-50 cursor-pointer py-3 md:py-2 text-xl md:text-2xl rounded-full shadow-lg border-black/20 font-medium text-[#1F3A5F] bg-linear-to-r from-[#D8B893] via-[#CEAC81] to-[#BFA06F] hover:shadow-lg hover:scale-105 transition-all duration-300">Sign Up</button></Link>
              </>
            )}
          </div>
