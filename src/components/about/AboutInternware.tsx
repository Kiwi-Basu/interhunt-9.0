  ...
  return (
    <>
      <section id="About-Internware">
        <div className="min-h-screen bg-linear-to-br from-[#FFFFFF] via-[#F8FAFC] to-[#EEF2F7] p-20 flex flex-col items-center relative overflow-hidden">
          ...
          <div className="max-w-5xl flex flex-col gap-8 relative z-10">
            ...
            <div className="flex gap-6 mt-4">
              {stats.map((stat, idx) => (
                <div
                  key={idx}
                  className="flex-1 h-44 border border-[#CEAC81]/30 bg-white rounded-3xl shadow-md hover:shadow-xl flex flex-col items-center justify-center gap-3 hover:-translate-y-2 transition-all duration-300 cursor-default"
                >
                  <p className="text-5xl font-black text-[#1F3A5F]">
                    {stat.value}
                  </p>
