  ...
  return (
    <>
      <section id="Contact-location">
        <div className="min-h-screen p-20 flex flex-col items-center bg-gradient-to-br from-[#FFFFFF] via-[#FAFAFA] to-[#F1F5F9] relative overflow-hidden">
          ...
          {/* Map card */}
          <div className="border border-[#CEAC81]/20 p-3 rounded-3xl shadow-xl bg-white relative z-10 hover:shadow-lg transition-all duration-300">
            <iframe
