        ...
        <div className="min-h-screen bg-linear-to-br from-[#f6f0f0] via-[#e8dede] to-[#d6cfcf] flex flex-col items-center p-20">
          ...
          <div className="flex flex-wrap justify-evenly">
            {company2.map((company,idx)=> {
              return (
                <div key={idx} className="relative  border-2 border-[#f1f0e1] bg-black/10 backdrop-blur-xl shadow-2xl rounded-3xl flex flex-col w-75 p-6 gap-4 mt-10 transition-all duration-500 hover:scale-105 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
